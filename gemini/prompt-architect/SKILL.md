...
description: Use this skill when the user says "/prompt-architect", "give me a prompt", "create a prompt for", "build a prompt", "generate a prompt", "turn this into a prompt", "make a structured prompt", "write a prompt for", or describes something they want an AI to do and asks for a well-structured prompt to accomplish it. Transforms rough user requests into complete, structured prompts with six labeled sections: Role, Task, Context Block, Goal/Stakes, Completion Criteria, and Output Format.
---
...
Before writing anything, scan the user's request for these four signal types:
...
Once the user answers, treat their answers as additional context and continue to Step 2.
